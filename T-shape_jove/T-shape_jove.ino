...
void loop() {
  if (startTask) {
    ...
    if (digitalRead(PORKING3) && rl == 0 && prevPork == 1) {
      stopTime = millis();
    ...
    else if  (digitalRead(PORKING3) && rl == 1 && prevPork == 1) {
      stopTime = millis();
      Serial.println(stopTime - startTime);
      analogWrite(SP4, 0);
      digitalWrite(FEED1, LOW);
    ...
    if (digitalRead(PORKING1) && rl == 1 && prevPork == 2) {
    ...
    else if (digitalRead(PORKING1) && rl == 0  && prevPork == 2) {
      digitalWrite(FEED1, LOW);
      digitalWrite(FEED2, LOW);
      digitalWrite(FEED3, LOW);
      digitalWrite(FEED4, LOW);
    ...
    if (digitalRead(PORKING4) && rl == 0  && prevPork == 2) {
      digitalWrite(FEED1, LOW);
      digitalWrite(FEED2, LOW);
      digitalWrite(FEED3, LOW);
    ...
    else if (digitalRead(PORKING4) && rl == 1 && prevPork == 2) {
      digitalWrite(FEED1, LOW);
      digitalWrite(FEED2, LOW);
      digitalWrite(FEED3, LOW);
      digitalWrite(FEED4, LOW);
